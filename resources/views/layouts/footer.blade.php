<footer id="dtr-footer" class="dtr-section-with-bg"
                style="background-image: url(../images/footer-bg.png);">
                <div class="container">
                    <div class="row">

                        <!-- column 1 starts -->
                        <div class="col-12 col-sm-6 col-lg-4 dtr-mb-30"> <a href="#"
                                class="d-block dtr-mb-15"><img
                                    src="{{ asset('/images/icons/Brance-logos_white.png') }}" alt="logo"></a>
                            <p>Lorem ipsum dolor sit amet consect adipiscing elit, sed do eiusmod tempor incididunt
                                labore at dolore.</p>
                            <p>© 2022 Brance. All rights reserved.</p>
                        </div>
                        <!-- column 1 ends -->

                        <!-- column 2 starts -->
                        <div class="col-12 col-sm-6 col-lg-2 dtr-mb-30">
                            <h4 class="color-blue">Company</h4>
                        ...
                        <!-- column 3 starts -->
                        <div class="col-12 col-sm-6 col-lg-2 dtr-mb-30">
                            <h4 class="color-blue">Support</h4>
                            <ul class="dtr-list-simple">
                        ...
                        <div class="col-12 col-sm-6 col-lg-4 dtr-mb-30">
                            <h4 class="color-blue">Newsletter</h4>
                                    ...
                                    <fieldset>
                                        <div class="dtr-form-row-2col">
                                            ...
                                            <p class="dtr-form-column">
                                                <button class="dtr-btn btn-blue" type="submit">Subscribe</button>
                                            </p>
                                        </div>
                                    </fieldset>
                                </form>
                            ...
                            <div class="dtr-social-large">
                                <ul
                                    class="dtr-social dtr-social-list color-white-muted-alt accent-color-hover text-center">
                                    <li><a href="#" class="dtr-twitter" target="_blank" title="twitter"></a>
                                    </li>
                                    <li><a href="#" class="dtr-facebook" target="_blank" title="facebook"></a>
                                    </li>
                                    <li><a href="#" class="dtr-instagram" target="_blank"
                                            title="instagram"></a></li>
                                    <li><a href="#" class="dtr-github" target="_blank" title="github"></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
